...
%  ------------
% 
%  We will need to complete the following functions 
%  in this exericse:
%
%     sigmoidGradient.m
...
%  first so that it will be easier for you to debug. Later, in part 4, we
...
%  Once your cost function implementation is correct, we should now
...
%  implement the gradient for the sigmoid function. We should complete the
...
%  In this part of the exercise, we will be starting to implment a two
...
%  Once the cost matches up with ours, we should proceed to implement the
...
%  Once your backpropagation implementation is correct, we should now
